...
- Windows 경우
  ...
  - Category 탭에서  **Connection**  &rightarrow; **SSH**  &rightarrow; **Auth**  &rightarrow; **Private key file for authentication에서 **[Browse]** 클릭  &rightarrow; awslab.ppk 선택 ![](https://saltware-aws-lab.s3.ap-northeast-2.amazonaws.com/img/puttyauth.png)
